...
public class TestGroupSequence extends SequentialCommandGroup {
  /** Creates a new TestPathGroupSequence. */
  public TestGroupSequence(Drive_Train drivetrain) {
    ...
    Trajectory trajectory0 = TrajectoryCache.get("Test-Straight");
    ...
    Trajectory trajectory1 = TrajectoryCache.get("Test-StraightReverse");
